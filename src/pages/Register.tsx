...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!username.trim() || !email || password.length < 6) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0d0d0d] px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-neutral-500">Join the community of web novel readers</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-neutral-500">
          ...
          <Link to="/login" className="font-medium text-rose-400 hover:text-rose-300 transition">
            Sign In
          </Link>
        </p>
      </div>
